...
CONST BYTE EncryptedAPI[][50]
{
	...
	{ 0xE3, 0xD9, 0xF8, 0xC3, 0xC0, 0xCC, 0xDD, 0xFB, 0xC4, 0xC8, 0xDA, 0xE2, 0xCB, 0xFE, 0xC8, 0xCE, 0xD9, 0xC4, 0xC2, 0xC3, 0xAD }, // NtUnmapViewOfSection
	{ 0xE3, 0xD9, 0xFD, 0xDF, 0xC2, 0xD9, 0xC8, 0xCE, 0xD9, 0xFB, 0xC4, 0xDF, 0xD9, 0xD8, 0xCC, 0xC1, 0xE0, 0xC8, 0xC0, 0xC2, 0xDF, 0xD4, 0xAD }, // NtProtectVirtualMemory
	{ 0xE3, 0xD9, 0xFC, 0xD8, 0xC8, 0xDF, 0xD4, 0xFB, 0xC4, 0xDF, 0xD9, 0xD8, 0xCC, 0xC1, 0xE0, 0xC8, 0xC0, 0xC2, 0xDF, 0xD4, 0xAD }, // NtQueryVirtualMemory
	{ 0xE3, 0xD9, 0xE1, 0xC2, 0xCE, 0xC6, 0xFB, 0xC4, 0xDF, 0xD9, 0xD8, 0xCC, 0xC1, 0xE0, 0xC8, 0xC0, 0xC2, 0xDF, 0xD4, 0xAD }, // NtLockVirtualMemory
	{ 0xE3, 0xD9, 0xFF, 0xC8, 0xCC, 0xC9, 0xFB, 0xC4, 0xDF, 0xD9, 0xD8, 0xCC, 0xC1, 0xE0, 0xC8, 0xC0, 0xC2, 0xDF, 0xD4, 0xAD }, // NtReadVirtualMemory
	{ 0xE3, 0xD9, 0xFA, 0xDF, 0xC4, 0xD9, 0xC8, 0xFB, 0xC4, 0xDF, 0xD9, 0xD8, 0xCC, 0xC1, 0xE0, 0xC8, 0xC0, 0xC2, 0xDF, 0xD4, 0xAD, }, // NtWriteVirtualMemory
	{ 0xE3, 0xD9, 0xEC, 0xC1, 0xC1, 0xC2, 0xCE, 0xCC, 0xD9, 0xC8, 0xFB, 0xC4, 0xDF, 0xD9, 0xD8, 0xCC, 0xC1, 0xE0, 0xC8, 0xC0, 0xC2, 0xDF, 0xD4, 0xAD, }, // NtAllocateVirtualMemory
	{ 0xE3, 0xD9, 0xEB, 0xDF, 0xC8, 0xC8, 0xFB, 0xC4, 0xDF, 0xD9, 0xD8, 0xCC, 0xC1, 0xE0, 0xC8, 0xC0, 0xC2, 0xDF, 0xD4, 0xAD }, // NtFreeVirtualMemory
	{ 0xE3, 0xD9, 0xF9, 0xC8, 0xDF, 0xC0, 0xC4, 0xC3, 0xCC, 0xD9, 0xC8, 0xFD, 0xDF, 0xC2, 0xCE, 0xC8, 0xDE, 0xDE, 0xAD }, // NtTerminateProcess
	{ 0xE3, 0xD9, 0xFF, 0xC8, 0xDE, 0xD8, 0xC0, 0xC8, 0xFD, 0xDF, 0xC2, 0xCE, 0xC8, 0xDE, 0xDE, 0xAD }, // NtResumeProcess
	{ 0xE3, 0xD9, 0xFC, 0xD8, 0xC8, 0xDF, 0xD4, 0xE4, 0xC3, 0xCB, 0xC2, 0xDF, 0xC0, 0xCC, 0xD9, 0xC4, 0xC2, 0xC3, 0xFD, 0xDF, 0xC2, 0xCE, 0xC8, 0xDE, 0xDE, 0xAD }, // NtQueryInformationProcess
	{ 0xE3, 0xD9, 0xFE, 0xC8, 0xD9, 0xE4, 0xC3, 0xCB, 0xC2, 0xDF, 0xC0, 0xCC, 0xD9, 0xC4, 0xC2, 0xC3, 0xFD, 0xDF, 0xC2, 0xCE, 0xC8, 0xDE, 0xDE, 0xAD, }, // NtSetInformationProcess
	{ 0xFF, 0xD9, 0xC1, 0xF8, 0xDE, 0xC8, 0xDF, 0xF9, 0xC5, 0xDF, 0xC8, 0xCC, 0xC9, 0xFE, 0xD9, 0xCC, 0xDF, 0xD9, 0xAD, }, // RtlUserThreadStart
	{ 0xE3, 0xD9, 0xEE, 0xDF, 0xC8, 0xCC, 0xD9, 0xC8, 0xF9, 0xC5, 0xDF, 0xC8, 0xCC, 0xC9, 0xE8, 0xD5, 0xAD }, // NtCreateThreadEx	
	{ 0xE3, 0xD9, 0xF9, 0xC8, 0xDF, 0xC0, 0xC4, 0xC3, 0xCC, 0xD9, 0xC8, 0xF9, 0xC5, 0xDF, 0xC8, 0xCC, 0xC9, 0xAD }, // NtTerminateThread
	{ 0xE3, 0xD9, 0xFC, 0xD8, 0xC8, 0xDF, 0xD4, 0xE4, 0xC3, 0xCB, 0xC2, 0xDF, 0xC0, 0xCC, 0xD9, 0xC4, 0xC2, 0xC3, 0xF9, 0xC5, 0xDF, 0xC8, 0xCC, 0xC9, 0xAD, }, // NtQueryInformationThread
	{ 0xE3, 0xD9, 0xFE, 0xC8, 0xD9, 0xE4, 0xC3, 0xCB, 0xC2, 0xDF, 0xC0, 0xCC, 0xD9, 0xC4, 0xC2, 0xC3, 0xF9, 0xC5, 0xDF, 0xC8, 0xCC, 0xC9, 0xAD }, // NtSetInformationThread
	{ 0xFF, 0xD9, 0xC1, 0xEC, 0xCE, 0xDC, 0xD8, 0xC4, 0xDF, 0xC8, 0xFD, 0xDF, 0xC4, 0xDB, 0xC4, 0xC1, 0xC8, 0xCA, 0xC8, 0xAD, }, // RtlAcquirePrivilege
	{ 0xFF, 0xD9, 0xC1, 0xFF, 0xC8, 0xC1, 0xC8, 0xCC, 0xDE, 0xC8, 0xFD, 0xDF, 0xC4, 0xDB, 0xC4, 0xC1, 0xC8, 0xCA, 0xC8, 0xAD, }, // RtlReleasePrivilege
	{ 0xFF, 0xD9, 0xC1, 0xEC, 0xC9, 0xC9, 0xFB, 0xC8, 0xCE, 0xD9, 0xC2, 0xDF, 0xC8, 0xC9, 0xE8, 0xD5, 0xCE, 0xC8, 0xDD, 0xD9, 0xC4, 0xC2, 0xC3, 0xE5, 0xCC, 0xC3, 0xC9, 0xC1, 0xC8, 0xDF, 0xAD }, // RtlAddVectoredExceptionHandler
	{ 0xE1, 0xC9, 0xDF, 0xFF, 0xC8, 0xCA, 0xC4, 0xDE, 0xD9, 0xC8, 0xDF, 0xE9, 0xC1, 0xC1, 0xE3, 0xC2, 0xD9, 0xC4, 0xCB, 0xC4, 0xCE, 0xCC, 0xD9, 0xC4, 0xC2, 0xC3, 0xAD, }, // LdrRegisterDllNotification
	{ 0xE3, 0xD9, 0xE9, 0xD8, 0xDD, 0xC1, 0xC4, 0xCE, 0xCC, 0xD9, 0xC8, 0xE2, 0xCF, 0xC7, 0xC8, 0xCE, 0xD9, 0xAD }, // NtDuplicateObject
	{ 0xE1, 0xC2, 0xCC, 0xC9, 0xE1, 0xC4, 0xCF, 0xDF, 0xCC, 0xDF, 0xD4, 0xEC, 0xAD, }, // LoadLibraryA 
	{ 0xE1, 0xC2, 0xCC, 0xC9, 0xE1, 0xC4, 0xCF, 0xDF, 0xCC, 0xDF, 0xD4, 0xFA, 0xAD, }, // LoadLibraryW
	{ 0xE1, 0xC2, 0xCC, 0xC9, 0xE1, 0xC4, 0xCF, 0xDF, 0xCC, 0xDF, 0xD4, 0xE8, 0xD5, 0xEC, 0xAD, }, // LoadLibraryExA
	{ 0xE1, 0xC2, 0xCC, 0xC9, 0xE1, 0xC4, 0xCF, 0xDF, 0xCC, 0xDF, 0xD4, 0xE8, 0xD5, 0xFA, 0xAD, }, // LoadLibraryExW
	{ 0xE1, 0xC9, 0xDF, 0xE1, 0xC2, 0xCC, 0xC9, 0xE9, 0xC1, 0xC1, 0xAD, }, // LdrLoadDll
	{ 0xEE, 0xDF, 0xC8, 0xCC, 0xD9, 0xC8, 0xFD, 0xDF, 0xC2, 0xCE, 0xC8, 0xDE, 0xDE, 0xFA, 0xAD, }, // CreateProcessW
	{ 0xEE, 0xDF, 0xC8, 0xCC, 0xD9, 0xC8, 0xEB, 0xC4, 0xC1, 0xC8, 0xFA, 0xAD, }, // CreateFileW
